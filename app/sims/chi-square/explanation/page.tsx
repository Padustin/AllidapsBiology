...
export default function Page() {
  ...
  return (
    <div style={{ display: "grid", gap: 16, color: text }}>
      <div style={{ border: `1px solid ${border}`, borderRadius: 14, padding: 14, background: cardBg }}>
      ...
      <div style={{ border: `1px solid ${border}`, borderRadius: 14, padding: 14, background: cardBg }}>
        ...
        <ul style={{ lineHeight: 1.55 }}>
          ...
          <li><b>χ² statistic:</b> sum of (O−E)²/E across categories; larger values mean observed counts are farther from expectations.</li>
      ...
      <div style={{ border: `1px solid ${border}`, borderRadius: 14, padding: 14, background: cardBg }}>
        ...
        <p style={{ marginTop: 10 }}>Compute each category's (O−E)²/E, then add them.</p>
      </div>
      ...
      <div style={{ border: `1px solid ${border}`, borderRadius: 14, padding: 14, background: cardBg }}>
              ...
              <tbody>
                {O.map((o, i) => (
                  <tr key={i}>
                    ...
                    <td style={{ borderBottom: `1px solid ${border}`, padding: 8 }}>{contrib[i].toFixed(3)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div style={{ border: `1px solid ${border}`, borderRadius: 14, padding: 14, background: "#fff" }}>
          ...
          <ul style={{ lineHeight: 1.5 }}>
            ...
            <li><b>χ²:</b> computes how far 60/40 is from 50/50 by summing (O−E)²/E for heads and tails.</li>
